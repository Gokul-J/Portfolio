  ...
  return (
    <div id={id} className="welcome">
      <div className="text-center welcome-content">
        ...
        <button className="view-works p-0"><Link className="view" activeClass="active" to="skills" offset={-50} smooth={true} duration={500}>VIEW MY WORK <i class="fas fa-arrow-down ml-1"></i></Link></button>
      </div>
    </div>
  )
}