...
export default function Contact({ id }) {
  return (
    <div id={id} className="text-center">
      <button className="top" onClick={Scroll.scrollToTop}><i className="goToTop fas fa-angle-double-up"></i></button>
      <div className="container">
        ...
        <br />
        <a href={cv} target="_blank" rel="noopener noreferrer" className="cv"><i className="fas fa-file-pdf mr-2"></i> MY CV </a><br />
        <br />
        <div>
          <span className="details">
            <a href="mailto: jgokul2000@gmail.com" target="_blank" rel="noopener noreferrer"><i className="contact-icon far fa-envelope"></i></a>
        ...
        <blockquote className="blockquote text-center">
          ...
          <footer className="blockquote-footer">Elon Musk <cite title="Source Title"></cite></footer>
        </blockquote>
        <p>GOKUL J©2020</p>
      </div>
    </div>
